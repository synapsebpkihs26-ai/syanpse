    ...
    <section className="py-12">
      <Container className="space-y-10">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr,0.9fr]">
          <div className="glass relative h-full overflow-hidden rounded-3xl border border-white/10 bg-white/5">
            ...
            <div className="relative flex flex-col gap-6 p-6">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-xs uppercase tracking-[0.18em] text-amber-100">Rules & Regulations</p>
                  <h2 className="text-xl font-extrabold">RULES & REGULATIONS – Synapse 2026, BPKIHS Dharan</h2>
                </div>
              ...
              <div className="relative max-h-[620px] space-y-4 overflow-y-auto pr-2 text-sm text-white/80">
                {registrationRules.map((section, idx) => (
                  <div key={section.title} className="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">
          ...
          <div className="glass relative h-full overflow-hidden rounded-3xl border border-white/10 bg-white/5">
            <div className="absolute inset-0 bg-gradient-to-br from-plasma/12 via-magenta/10 to-ember-500/12" aria-hidden />
            <div className="relative flex h-full flex-col gap-6 p-6">
              <div className="space-y-2">
                <p className="text-xs uppercase tracking-[0.18em] text-amber-100">ID Card & Registration</p>
                <h2 className="text-xl font-extrabold">ID CARD</h2>
                <p className="text-sm text-white/70">
                  Walk through why the BR ID Card matters, how to secure it, and what conduct keeps access active during Synapse.
                </p>
              </div>
